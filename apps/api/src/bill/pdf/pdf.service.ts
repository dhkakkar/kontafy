...
export class PdfService implements OnModuleDestroy {
  ...
  constructor(private readonly prisma: PrismaService) {
    // R2_* env vars are populated at boot from OpenBao — see
    // apps/api/src/common/bao/fetch-r2-creds.ts. If they're missing at
    // construction, S3 calls will fail loudly instead of silently using
    // a stale hardcoded key.
